...
function motorClearance() = useReversedBelts() ? [17.6+2, 15, 0.5] : _useCNC ? [ 3, 7, 0.5 ] : [ 2, 7, 0.5 ]; // y value was 6, changed to 8 for better carbon fiber variants, should hot affect print volume
